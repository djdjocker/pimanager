 ...
 */
static int mailbox_property(int file_desc, unsigned int *buf)
{
 ...
 */
static unsigned int* get_overscan(int file_desc, unsigned int coord[4])
{
    int i=0;
...
/*  Get the current values for overscan */
static PyObject* get_overscan_func(PyObject* self, PyObject* args){
    int file_desc;
    ...
    return Py_BuildValue("[i,i,i,i]", coord[0], coord[1], coord[2], coord[3]);
}
 ...
 */
static unsigned int* set_overscan(int file_desc, unsigned int coord[4])
{
   int i=0;
   unsigned int property[32];
   property[i++] = 0;
...
static PyObject* set_overscan_func(PyObject* self, PyObject* args){
    int file_desc;
    unsigned int coord[4];
...
static PyMethodDef OverscanMethods[] =
{
     {"get", get_overscan_func, METH_VARARGS, "Get the current values for overscan"},
     
     {"set", set_overscan_func, METH_VARARGS, "Get the current values for overscan"},
...
initoverscan(void)
{
     (void) Py_InitModule("overscan", OverscanMethods);
}
